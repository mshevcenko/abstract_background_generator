    ...
    def __init__(self,
        ...
        parameters = [
            Parameter(name="colors",
                      visible_name="Colors",
                      description="Defines the colors used for the generated patterns.",
            ...
            Parameter(name="noise_type",
                      ...
                      description="Selects the type of noise to generate.",
            ...
            Parameter(name="scale",
                      visible_name="Scale",
                      description="Adjusts the overall size and resolution of the noise pattern",
            ...
            Parameter(name="blur_radius",
                      ...
                      description="Specifies the radius used to smooth the generated noise.",
                      data_type=DataType.FLOAT,
                      visible_type=VisibleType.SLIDER,
                      default=1.0,
                      min_value=0.0,
            ...
            Parameter(name="octaves",
                      ...
                      description="Sets the number of detail levels for the noise generation. Higher values add more layers of complexity to the noise",
            ...
            Parameter(name="persistence",
                      ...
                      description="Controls the amplitude of each octave.",
                      data_type=DataType.FLOAT,
                      visible_type=VisibleType.SLIDER,
                      default=0.5,
                      min_value=0.1,
            ...
            Parameter(name="lacunarity",
                      ...
                      description="Determines how much the frequency increases between octaves",
                      data_type=DataType.FLOAT,
                      visible_type=VisibleType.SLIDER,
                      default=2.0,
                      min_value=0.5,
            ...
            Parameter(name="island_type",
                      ...
                      description="Enables or disables the generation of an island-like noise pattern",
