    ...
    def __init__(self,
        ...
        parameters = [
            Parameter(name="colors",
                      visible_name="Colors",
                      description="Specifies the set of colors used to draw lines in the generated flow field",
            ...
            Parameter(name="scale",
                      visible_name="Scale",
                      description="Controls the size and frequency of the noise used to generate the flow field.",
                      data_type=DataType.FLOAT,
                      visible_type=VisibleType.SLIDER,
                      default=1.0,
                      min_value=0.5,
                      max_value=100.0,
                      random_min_value=0.5,
                      random_max_value=100.0),
            Parameter(name="blur_radius",
                      visible_name="Blur radius",
                      description="Applies a Gaussian blur to the final image.",
                      data_type=DataType.FLOAT,
                      visible_type=VisibleType.SLIDER,
                      default=1.0,
                      min_value=0.0,
            ...
            Parameter(name="octaves",
                      ...
                      description="Defines the number of layers of noise combined to produce the flow field. Increasing octaves adds more detail",
            ...
            Parameter(name="line_count",
                      ...
                      description="Specifies the total number of lines drawn on the image",
                      data_type=DataType.INTEGER,
                      visible_type=VisibleType.SLIDER,
                      default=1000,
                      min_value=1,
                      max_value=10000,
                      random_min_value=1000,
                      random_max_value=10000),
            Parameter(name="line_length",
                      visible_name="Line_length",
                      description="Determines the maximum length of each line in the flow field.",
                      data_type=DataType.INTEGER,
                      visible_type=VisibleType.SLIDER,
                      default=100,
                      min_value=1,
            ...
            Parameter(name="line_width",
                      ...
                      description="Sets the thickness of each line in pixels",
                      data_type=DataType.INTEGER,
                      visible_type=VisibleType.SLIDER,
                      default=1,
                      min_value=1,
